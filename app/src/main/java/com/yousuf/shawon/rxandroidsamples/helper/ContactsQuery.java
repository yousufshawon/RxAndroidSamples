package com.yousuf.shawon.rxandroidsamples.helper;
...
public interface ContactsQuery {
  ...
  @SuppressLint("InlinedApi") final static String SELECTION =
  ...
  // key.
  @SuppressLint("InlinedApi") final static String SORT_ORDER =
      Utils.hasHoneycomb() ? Contacts.SORT_KEY_PRIMARY : Contacts.DISPLAY_NAME;

  // The projection for the CursorLoader query. This is a list of columns that the Contacts
  // Provider should return in the Cursor.
  @SuppressLint("InlinedApi") final static String[] PROJECTION = {
